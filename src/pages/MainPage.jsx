...
import cityImg from "../assets/kakao_city.jpg";

export default function MainPage() {
  return (
    <div className=" w-100 px-14 border-b-2 border-black">
      <div className="mt-32">
      ...
      <div className="text-center h-[500px]">
        ...
        <p className=" mt-16 text-xl leading-[1.7]">
          ...
          <br />
          우리의 관점, 행동하는 방법, 지향하는 목표까지 카카오스러움은 이미 우리
          안에 스며들어 있습니다. 우리가 더
          <br />
          나은 세상을 만들기 위해 고민하면서 자연스럽게 체득한 태도이자 본질이기
          때문입니다. 앞으로도 우리는
          <br />
      ...
      <div className="w-full h-fit flex flex-col items-center gap-20 pb-52">
        <div className=" w-4/5 h-auto border rounded-xl shadow-[2px_5px_40px_0_rgba(0,0,0,.09)] flex">
          <div className="w-1/2 h-full flex flex-col items-start p-20">
            ...
            <p className="mt-5 text-2xl text-neutral-500">Willing to Venture</p>
            <p className=" mt-24 text-lg leading-[1.8] font-normal">
              "가보지 않은 길은 위험하잖아?"
              <br />
              배는 정박해 있을 때 가장 안전하지만 그것은 배의 존재 이유가
              아닙니다. 가보지 않은 길은 실패의 위험이 따르지만 우리는 개선보다
              혁신의 길을 가는 사람들입니다. 문제 자체를 다시 정의하고 새로운
              해답을 찾는 것에 집중합니다. 도전이 두렵기만 하다면 카카오를 떠날
              때입니다.
            </p>
        ...
        <div className=" w-4/5 h-auto border rounded-xl shadow-[2px_5px_40px_0_rgba(0,0,0,.09)] flex">
          ...
          <div className="w-1/2 h-full flex flex-col items-start p-20">
            ...
            <p className=" mt-24 text-lg leading-[1.8] font-normal">
              ...
              출발합니다. 시작부터 다르게 질문합니다. 끊임없이 ‘왜?’라는 물음을
              던집니다. 그렇게 익숙한 것을 새롭게, 가치 있게 만듭니다.
            </p>
            <p className="text-lg text-neutral-400 mt-5">
              #본질에서출발 #생각에당연함없이
            </p>
        ...
        <div className=" w-4/5 h-auto border rounded-xl shadow-[2px_5px_40px_0_rgba(0,0,0,.09)] flex">
          <div className="w-1/2 h-auto flex flex-col items-start p-20">
            ...
            <p className=" mt-24 text-lg leading-[1.8] font-normal">
              "내가 항상 정답일까?"
              <br />
              개인의 완벽함에 기대기 보다 동료와 함께 완성해 나갑니다. 격렬한
              토론과 논쟁 속에서도 서로에 대한 신뢰가 있다면 반드시 더 나은 답을
              찾을 수 있습니다. 신뢰를 받기 위해서 상대방을 먼저 존중하세요.
        ...
        <div className=" w-4/5 h-auto border rounded-xl shadow-[2px_5px_40px_0_rgba(0,0,0,.09)] flex">
          ...
          <div className="w-1/2 h-full flex flex-col items-start p-20">
            ...
            <p className="mt-5 text-2xl text-neutral-500">Act for Yourself</p>
            <p className=" mt-24 text-lg leading-[1.8] font-normal">
              "왜 이 일을 할까?"
              <br />
              카카오 크루라면 가장 먼저 해야 하는 질문입니다. 우리는 일의
              원동력을 스스로 만들어냅니다. 내가 시켜서 하는 나의 일인거죠. 일에
              끌려다니지 않고 끌고 가기 위해서 언제나 내가 먼저 생각하고,
              질문하고, 움직입니다.
            </p>
            <p className="text-lg text-neutral-400 mt-5">
              #내가시킨내일 #할일은스스럼없이
        ...
        <div className=" w-4/5 h-fit border rounded-xl shadow-[2px_5px_40px_0_rgba(0,0,0,.09)] flex">
          <div className="w-1/2 h-auto flex flex-col items-start p-20">
            ...
            <p className=" mt-24 text-lg leading-[1.8] font-normal">
              ...
              기업입니다. 기업은 건강한 생태계를 만들어야하는 책임이 있습니다.
              카카오 또한 사회에 의미있는 변화를 만들기 위해 최선을 다합니다.
              서비스 하나에도 그런 생각과 노력들이 담겨있습니다. 그렇게 우리는
              오늘보다 더 나은 세상을 만듭니다.
            </p>
            <p className="text-lg text-neutral-400 mt-5">
              #사회적인책임 #놀라움은끊임없이
